class Movie
  ...
  define_method(:update) do |attributes|
    ...
    #below is the linkage of the of many to many relationships
  ...
  #end of CRUDL functionalities

  #make association between an actor and a movie with join table
